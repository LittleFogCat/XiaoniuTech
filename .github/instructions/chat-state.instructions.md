...
applyTo: "frontend/chat/src/App.jsx"
---

# Chat State Guidelines

- [frontend/chat/src/App.jsx](../../frontend/chat/src/App.jsx) owns two storage modes: logged-in users persist chats through backend CRUD APIs, while guest mode persists to localStorage.
