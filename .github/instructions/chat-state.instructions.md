...
- Guest keys, guest limits and logged-in 404 recreate are repository-level chat conventions now documented in [doc/convention.md](../../doc/convention.md). Preserve them unless the task explicitly includes a migration plan.
