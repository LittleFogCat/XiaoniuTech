...
applyTo:
  ...
  - "frontend/chat/src/services/api.js"
...
- [frontend/chat/src/services/api.js](../../frontend/chat/src/services/api.js) currently parses one JSON object per `data:` line and yields `obj.content`. Change the backend emitter and frontend parser together.
